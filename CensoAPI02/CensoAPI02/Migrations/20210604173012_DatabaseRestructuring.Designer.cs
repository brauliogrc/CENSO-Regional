...
namespace CensoAPI02.Migrations
{
    ...
    [Migration("20210604173012_DatabaseRestructuring")]
    partial class DatabaseRestructuring
    {
            ...
            modelBuilder.Entity("CensoAPI02.Models.AnonRequest", b =>
                {
                    b.HasOne("CENSO.Models.Question", "question")
                        .WithOne("anonRequest")
                        .HasForeignKey("CensoAPI02.Models.AnonRequest", "QuestionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
